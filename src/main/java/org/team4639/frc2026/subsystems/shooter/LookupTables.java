...
public class LookupTables {
  ...
  public static double getScoringRPM() {
    Pose3d targetPose = LimelightHelpers.getTargetPose3d_RobotSpace("limelight-turret");

    double distanceInMeters = targetPose.getTranslation().getNorm();

    double scoringRPM = scoringDistanceToRPM.get(distanceInMeters);
    return scoringRPM;
  }
}
